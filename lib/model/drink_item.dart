...
Future productPost(String name, String imgUrl, String recipe, String bar, String price) async{
 
 // Set up POST request arguments 
 var url = 'http://10.0.2.2:3000/products';
 Map<String, String> headers = {"Content-type": "application/json"};
 String json = '{"price": "$price", "name": "$name", "bar": "$bar", "recipe": "$recipe", "imgUrl": "$imgUrl"}';
